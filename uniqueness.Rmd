...
#' 
#' @param tib
#' @param dist_method: 'euclidean','mahalanobis','manhattan', 'minkowski'
...
wb_tib = wb_geo %>% st_drop_geometry() %>% rename(
  ...
  military_exp = ms.mil.xpnd.gd.zs
             ...
             urban_pop, income_group, internet_access, military_exp)
...
wb_uniq = dist_uniq(wb_trans_tib, 'euclidean')
#View(wb_uniq)
